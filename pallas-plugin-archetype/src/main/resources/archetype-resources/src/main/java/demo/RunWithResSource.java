...
public class RunWithResSource extends AbstractPallasSearchScript {
	...
	protected static final String REDIS_HOST = getOSProperty("VIP_MPCSEARCH_REDIS_MASTER_01_HOST", "10.198.195.220");
	protected static final String REDIS_PORT = getOSProperty("VIP_MPCSEARCH_REDIS_MASTER_01_PORT", "6379");
	protected static final String OTHER = "other";

	public static JedisPool POOL = getPool();

	protected static synchronized JedisPool getPool() {
		if (POOL == null) {

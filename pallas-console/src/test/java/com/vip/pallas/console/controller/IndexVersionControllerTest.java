...
public class IndexVersionControllerTest extends BaseControllerTest {
    ...
    public void test11AddIndexVersion() throws Exception{
        ...
        clusterName = indexVO.getClusterId();

        ResultVO<Cluster> resultVO = callGetApi("/cluster/id.json?clusterId=" + clusterName, Cluster.class);

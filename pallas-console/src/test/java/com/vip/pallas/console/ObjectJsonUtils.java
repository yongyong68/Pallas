...
//        dataSource.setIp(ConstantValue.dataSourceIp);
//        dataSource.setPort(ConstantValue.dataSourcePort);
//        dataSource.setDbname(ConstantValue.dataSourceDbName);
//        dataSource.setTableName(ConstantValue.dataSourceTableName);
//        dataSource.setUsername(ConstantValue.dataSourceUserName);
//        dataSource.setPassword(ConstantValue.dataSourcePassword);
//        indexVO.setDataSourceList(Arrays.asList(dataSource));

...
/**
 * 具体格式参考：http://wiki.corp.vipshop.com/pages/viewpage.action?pageId=162622213
 * @author freeman.he
 *
 */
public class MonitorAccessLog {
	...
	private void writeAccessLog(int status, int mercuryCode, long body_bytes_sent, ServiceInfo serviceInfo, String traceId, SessionContext ctx){
		...
		// access-log格式 : http://wiki.corp.vipshop.com/pages/viewpage.action?pageId=162622213

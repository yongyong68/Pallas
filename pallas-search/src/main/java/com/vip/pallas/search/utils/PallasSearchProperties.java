...
public class PallasSearchProperties extends PallasBasicProperties {
	...
	public static final String CONSOLE_UPLOAD_URL = processor.getString(NAME_CONSOLE_UPLOAD_URL, processor.getString(PALLAS_CONSOLE_REST_URL, "http://pallas.vip.vip.com/pallas") + "/ss/upsert.json");

...
INSERT INTO `cluster` VALUES (1,'pallas-test-cluster','开源测试演示','127.0.0.1:9200','127.0.0.1:9300',NULL,now(),0,'','SHARED-CLUSTER');

INSERT INTO `index` (`id`, `index_name`, `description`, `cluster_name`, `stat`, `create_time`, `update_time`, `is_deleted`, `timeout`, `retry`, `slower_than`) VALUES ('1', 'product_comment', '商品评价测试索引', 'pallas-test-cluster', 'inactive', now(), now(), '0', '0', '0', '200');


INSERT INTO `index_routing` (`id`, `index_id`, `index_name`, `type`, `routings_info`, `create_time`, `update_time`, `is_deleted`) VALUES ('1', '1', 'product_comment', 'index', '[{"name":"Default","conditionRelation":"AND","conditions":[],"targetGroups":[{"id":1,"weight":1}],"enable":true}]', now(), now(), '0');


INSERT INTO `authorization` (`id`, `client_token`, `title`, `authorization_items`, `is_enabled`, `create_time`, `update_time`, `is_deleted`) VALUES ('1', 'XQx0dVPGB1dlPn3ZTDjaXw==', 'product_comment测试token', '[{"id":1,"name":"pallas-test-cluster","privileges":{},"indexPrivileges":[{"id":1,"name":"product_comment","privileges":{"IndexAll":["ReadOnly"]},"indexPrivileges":null}]}]', '1', now(), now(), '0');


INSERT INTO `index_routing_target_group` (`id`, `index_id`, `index_name`, `type`, `name`, `nodes_info`, `clusters_info`, `state`, `cluster_level`, `create_time`, `update_time`, `is_deleted`) VALUES ('1', '1', 'product_comment', 'index', 'Default', '[]', '[{"cluster":"pallas-test-cluster","name":"pallas-test-cluster","address":"127.0.0.1:9200"}]', '0', '2', now(), now(), '0');


INSERT INTO `search_template` (`id`, `index_id`, `template_name`, `content`, `params`, `type`, `create_time`, `update_time`, `is_deleted`, `timeout`, `retry`) VALUES ('1', '1', 'product_comment_search', '{
 ...
 INSERT INTO `search_template_h` (`id`, `template_id`, `description`, `creator`, `content`, `params`, `create_time`, `is_deleted`) VALUES ('1', '1', 'product_comment_search', 'admin', '{
     "from": {{from}}{{^from}}0{{/from}},
     "size": {{size}}{{^size}}30{{/size}},
     "sort":[{"post_time": "desc"}],
     "query": {

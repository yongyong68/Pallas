...
//		httpClient.getParams().setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 30000); 
        ...
        try {
    		...
    		httpDelete.setHeader("Authorization", ConfigReader.getProperty("saturn.rest.authorization.key"));
...
//		httpClient.getParams().setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 30000);
        ...
        try {
        	...
        	httpPost.setHeader("Authorization", ConfigReader.getProperty("saturn.rest.authorization.key"));
...
//		httpClient.getParams().setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 30000);
        ...
        try {
        	...
        	httpGet.setHeader("Authorization", ConfigReader.getProperty("saturn.rest.authorization.key"));

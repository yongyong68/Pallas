...
public class ClusterServiceImplTest extends BaseSpringTest {
	...
	public void testCrud() throws Exception {
		...
		c.setClientAddress("192.168.200.220:9300");
		c.setHttpAddress("http://192.168.200.220:9200");
	...
	public void testSelectAllPhysicalClustersByIndexId(){
		List<Cluster> selectAllPhysicalClusters = clusterService.selectPhysicalClustersByIndexId(4531L);
		assertThat(selectAllPhysicalClusters.size()).isGreaterThan(0);
	}
